...
<form:form modelAttribute="thisCartItem">
...
<c:set var="totalPrice" value="${thisCartItem.price}"/>

<tr>
<td class="login-signup-panel">
<img src="resources/data/PRDT-${thisCartItem.productId}.jpg" height="100px"/>
</td>

<td>
<b>${thisCartItem.productName}</b>
</td>
