...
id='agree'/><b>&nbsp; I Agree To All ShopNScroll <a href="terms" target="_blank" style="color:green;text-decoration: none;">Policies,Terms And Conditions</a></b>
<br><br>
...
<input type="submit" id="continue1" name="_eventId_continue" class="signup-button btn btn-lg btn-orange pull-right newpager" value="Continue" disabled="true"/>
